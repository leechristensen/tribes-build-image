...
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TShellAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//
TShellAboutDlg::TShellAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
void TShellAboutDlg::SetupWindow()
{
