...
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TApxSdiDvEditView (TEditView).
//
//----------------------------------------------------------------------------
...
//{{TApxSdiDvEditView Implementation}}


//
// Build a response table for all messages/commands handled
// by TApxSdiDvEditView derived from TEditView.
//
DEFINE_RESPONSE_TABLE1(TApxSdiDvEditView, TEditView)
...
//
TApxSdiDvEditView::TApxSdiDvEditView(TDocument& doc, TWindow* parent)
:
...
TApxSdiDvEditView::~TApxSdiDvEditView()
{
...
//
void TApxSdiDvEditView::Paint(TDC& dc, bool, TRect& rect)
{
  TApxSdiDvApp* theApp = TYPESAFE_DOWNCAST(GetApplication(), TApxSdiDvApp);
  if (theApp) {
...
void TApxSdiDvEditView::EvGetMinMaxInfo(MINMAXINFO far& minmaxinfo)
{
  TApxSdiDvApp* theApp = TYPESAFE_DOWNCAST(GetApplication(), TApxSdiDvApp);
  if (theApp) {
    if (theApp->Printing) {
