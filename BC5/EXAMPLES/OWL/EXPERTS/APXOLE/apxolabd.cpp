...
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TApxOleAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TApxOleAboutDlg Implementation}}
...
//
TApxOleAboutDlg::TApxOleAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TApxOleAboutDlg::~TApxOleAboutDlg()
{
  Destroy();
...
void TApxOleAboutDlg::SetupWindow()
{
