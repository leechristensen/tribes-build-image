...
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TApxMdiAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TApxMdiAboutDlg Implementation}}
...
//
TApxMdiAboutDlg::TApxMdiAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TApxMdiAboutDlg::~TApxMdiAboutDlg()
{
  Destroy();
...
void TApxMdiAboutDlg::SetupWindow()
{
