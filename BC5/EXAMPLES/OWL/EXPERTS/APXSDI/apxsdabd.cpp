...
//  OVERVIEW
//  ~~~~~~~~
//  Source file for implementation of TApxSdiAboutDlg (TDialog).
//
//----------------------------------------------------------------------------
...
//{{TApxSdiAboutDlg Implementation}}
...
//
TApxSdiAboutDlg::TApxSdiAboutDlg(TWindow* parent, TResId resId, TModule* module)
:
...
TApxSdiAboutDlg::~TApxSdiAboutDlg()
{
  Destroy();
...
void TApxSdiAboutDlg::SetupWindow()
{
