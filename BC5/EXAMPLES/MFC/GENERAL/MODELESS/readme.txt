========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : MODELESS
========================================================================


AppWizard has created this MODELESS application for you.  This application
...
nmake /f MODELESS.MAK CFG="Win32 Debug"
    or to build a release version of the program, type
nmake /f MODELESS.MAK CFG="Win32 Release"
...
MODELDLG.H, MODELDLG.CPP - the dialog
    These files contain your CModelessDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in MODELESS.RC, which can be edited in the Visual C++
