...
// Inlines
// Properties
DEFINE_DB_PROP_DATAFIELD( TDBMemo, _TDBMemo )
DEFINE_DB_PROP_TSTRINGS( TDBMemo, _TDBMemo, Lines )
DEFINE_DB_PROP_STRING( TDBMemo, _TDBMemo, FontName );
DEFINE_DB_PROP_STRING( TDBMemo, _TDBMemo, SelText );
